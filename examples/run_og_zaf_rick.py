...
def main():
    ...
    base_dir = os.path.join(CUR_DIR, "OG-ZAF-RickEx", "OUTPUT_BASELINE")
    reform_dir = os.path.join(CUR_DIR, "OG-ZAF-RickEx", "OUTPUT_REFORM")
    ...
    op.plot_all(
        base_dir, reform_dir, os.path.join(
            CUR_DIR, "OG-ZAF-RickEx", "OG-ZAF_example_plots"
        )
    )

    print("Percentage changes in aggregates:", ans)
    # save percentage change output to csv file
    ans.to_csv(os.path.join(
        CUR_DIR, "OG-ZAF-RickEx", "ogzaf_example_output.csv"
    ))
